...
const SELENA_GOMEZ = {
    name: 'Selena Gomez',
    description: 'Feat. Adrian Grande, Demi Lovato and more',
...
const MAJOR_LAZER = {
    ...
    imageUrl: 'http://iscale.iheart.com/catalog/artist/443557?ops=fit(250,0)'
};
const TAYLOR_SWIFT = {
    name: 'Taylor Swift',
...
const ARTISTS = [THE_WEEKND, SELENA_GOMEZ, R_CITY, JUSTIN_BIEBER, MAJOR_LAZER, TAYLOR_SWIFT];
